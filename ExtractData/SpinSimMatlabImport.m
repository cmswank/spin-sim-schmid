...
%
%    /home/cmswank/spin-sim/ExtractData/dataSpecular.txt
%
% To extend the code to different selected data or a different text file,
% generate a function instead of a script.

% Auto-generated by MATLAB on 2016/04/26 10:26:34

%% Initialize variables.
filename = '/home/cmswank/spin-sim/ExtractData/dataSpecular.txt';
delimiter = ' ';
...
Sx = cell2mat(rawNumericColumns(:, 1));
Sy = cell2mat(rawNumericColumns(:, 2));
Sz = cell2mat(rawNumericColumns(:, 3));
X = cell2mat(rawNumericColumns(:, 4));
Y = cell2mat(rawNumericColumns(:, 5));
Z = cell2mat(rawNumericColumns(:, 6));
t = cell2mat(rawNumericColumns(:, 7));
Event = rawCellColumns(:, 1);
Bin = rawCellColumns(:, 2);
