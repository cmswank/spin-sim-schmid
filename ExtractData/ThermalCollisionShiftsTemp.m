function [dfmsd,dfm, dw, fw]= ThermalCollisionShiftsTemp(wdress,B1,gamma,B0,Grad,Lx)
...
b=ones(100,1)*b*100^2; %Convert speed to correct units!
...
lx=(1:2:2*size(w,1))'*w;        %fourier transform coefficient indicie (only positive indicies)
