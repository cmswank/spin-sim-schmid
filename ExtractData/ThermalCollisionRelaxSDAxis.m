function [T2,fwsd,T2McgregorRf,lam]= ThermalCollisionRelaxJ0(wdress,B1,gamma,B0,Temp,Grad,Lx)
...
%T1
w0f=gammap/gammaG;
R2=gamma^2*Grad^2./4.*real(Sxtheorysd);
%disp(Grad);
...
R2McGregorRF=Lx^4*gamma^2*(Grad)^2/4/120/D3.*(1./(1+wm.^2.*Lx.^4./D3.^2./pi.^4)+1./(1+wp.^2.*Lx.^4./D3.^2./pi.^4));
