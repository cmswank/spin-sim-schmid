//g++ -o extractrootbinary TimeSxSySzBinBinaryArguments.cpp `root-config --cflags --glibs`
#include <fstream>
#include <iostream>
#include <sstream>
#include <stdlib.h>
...
{	
	...
	*/
	...
	stringstream ss1;	
	ss1<<"/home/cmswank/spin-sim-heatflush/ExtractData/run"<<run<<".root";
	...
	//open root file
	TFile *myFile = TFile::Open(filename1.c_str());
	...
	stringstream ss2;
	ss2<<"/home/cmswank/spin-sim-heatflush/ExtractData/OutputHeatflush"<<run<<".dat";
	string filename2=ss2.str();
	ofstream  myfile;
   
	//format file
 	myfile.open (filename2,ios::binary | ios::out);
